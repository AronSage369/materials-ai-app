...
class MaterialsAIEngine:
    ...
    def _conservative_agent(self, balanced_compounds, specialist_compounds, strategy, categorized_compounds=None):
    ...
    def _practical_agent(self, balanced_compounds, specialist_compounds, strategy, categorized_compounds=None):
    ...
    def _high_performance_agent(self, balanced_compounds, specialist_compounds, strategy, categorized_compounds=None):
    ...
    def _balanced_agent(self, balanced_compounds, specialist_compounds, strategy, categorized_compounds):
        """Balanced agent seeking optimal trade-offs"""
        all_compounds = balanced_compounds + specialist_compounds
        if not all_compounds:
            return None
            
        # Decide on formulation type
        formulation_type = random.choices(
            ['pure', 'mixture', 'solute_solvent'], 
            weights=[0.3, 0.4, 0.3]
        )[0]
